...
pub fn build_fullnode_message(
    ...
    let mut message = HashMap::new();
    message.insert("account".to_string(), Value::String(account_address.to_string()));
    message.insert("payload".to_string(), Value::String(json_payload.to_string()));
    message.insert("timestamp".to_string(), Value::String(signature_timestamp.to_string()));
    message.insert("version".to_string(), Value::String(signature_version.to_string()));
